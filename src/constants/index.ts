...
// src/constants/index.ts 3:49:45
...
//READ DIRECTLY FOR OUR ENVs
//codderabbit added the suggestion to validatde that we hve access to all of these envs
//in case we dnt the app wont work 4:51:40
  //add validations for the following envs with junie 4:51:55
const getEnvVar = (key:string)=>{ //4:52:10
...
export const BASE_URL = getEnvVar("VITE_BACKEND_BASE_URL");
